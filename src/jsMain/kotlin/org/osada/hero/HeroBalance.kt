...
data class HeroBalance(
    ...
    /** Recognition floor below which a formation cannot yet produce an officer at all. */
     ...
     * counter rises on every failed eligible roll and is what makes long officerless stretches
     * self-correcting.
     */
    ...
    /** When an officer emerges early, the base chance it is the reserved legendary rather than procedural (§6.4). */
